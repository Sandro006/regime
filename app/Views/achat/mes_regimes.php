    ...
    <header class="bg-surface/90 sticky top-0 z-50 border-b border-outline-variant/30">
        <div class="flex justify-between items-center w-full px-container-margin py-sm max-w-7xl mx-auto">
            ...
            <nav class="hidden md:flex items-center gap-lg">
                ...
                <a class="text-on-surface-variant hover:text-primary transition-colors" href="/regime">Régimes</a>
                <a class="text-primary font-bold border-b-2 border-primary" href="/achat/mesRegimes">Mes régimes</a>
