...
<h1 class="font-display-md text-display-md font-bold text-primary dark:text-primary-fixed-dim">VitalPath</h1>
</div>
...
<p class="text-on-surface-variant font-body-lg text-body-lg">Joined VitalPath in <?php echo date('F Y'); ?></p>
<div class="mt-md flex flex-wrap justify-center md:justify-start gap-sm">
<button class="px-lg py-sm bg-primary text-on-primary rounded-lg font-label-caps text-label-caps hover:shadow-lg active:scale-95 transition-all">Edit Profile</button>
...
<span class="font-label-caps text-label-caps opacity-80">VitalPath Wallet</span>
</div>
...
<p class="font-body-lg text-body-lg font-semibold"><?php echo isset($user) ? htmlspecialchars($user['email']) : 'alex.richardson@vitalpath.com'; ?></p>
</div>
<div class="border-b border-surface-variant pb-sm">
...
<div>
<p class="font-body-md text-body-md font-semibold">Verified Account</p>
<p class="text-[12px] text-on-surface-variant">Your email and identity are confirmed.</p>
</div>
</li>
<li class="flex items-center gap-md">
...
<div>
<p class="font-body-md text-body-md font-semibold">Security Update</p>
<p class="text-[12px] text-on-surface-variant">Last password change: 4 months ago.</p>
</div>
</li>
<li class="flex items-center gap-md">
...
<div>
<p class="font-body-md text-body-md font-semibold">Auto-Recharge</p>
<p class="text-[12px] text-on-surface-variant">Enabled for amounts below 10€.</p>
</div>
</li>
</ul>
</div>
...
<span class="font-label-caps text-label-caps">Diets</span>
</a>
<a class="flex flex-col items-center justify-center text-on-surface-variant py-1 hover:bg-surface-variant/50 transition-all active:scale-90 duration-150" href="#">
<span class="material-symbols-outlined">fitness_center</span>
<span class="font-label-caps text-label-caps">Activities</span>
</a>
<a class="flex flex-col items-center justify-center text-on-surface-variant py-1 hover:bg-surface-variant/50 transition-all active:scale-90 duration-150" href="#">
